...
public class FaturaOdemeleri extends DbConnection implements IBilgiController {
    ...
    public boolean bilgilerGecerliMi() {
        return !(this.faturaIsmi == null
                || this.faturaTutari == 0
                //gelen fatura tutarı bakiyemizden büyükse
...
//faturaların sıfırlanma işleminin kullanıcının da görebilmesi için yazıldı bu method.
    private void faturayiSifirla() {
        if(bilgilerGecerliMi()) {
            switch(this.faturaIsmi) {
                //fatura ismi elektrik ise elektrik faturasını sıfırla
                case "elektrik":
