    ...
    public boolean havaleYapildiMi() {
        if (bilgilerGecerliMi()) {
            ...
            try {
                ...
                //2. sorgu gerçekleştiyse 1. sorguyu da çalıştır ve bakiyeyi düşür
...
//havale ekranından gelecek bilgiler kontrol edilecek
//gönderilecek miktar ve havale alacak kişi(müşteri numarası) kontrol edilecek
        return !(this.gonderilecekMiktar == 0
                || this.havaleAlacakKisi == null
                //gönderilecek miktar bakiyeden büyükse yine false döndür
                || this.gonderilecekMiktar > getHesapBilgileri().getBakiye()
                //kullanıcı kendine de havale yapamasın
