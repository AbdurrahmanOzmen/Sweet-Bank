...
public class TelNoYenileme extends DbConnection implements IBilgiController {
    ...
    public boolean bilgilerGecerliMi() {
        //telno boşsa veya girilen telefon numarasının uzunluğu 11 haneden azsa false döndür
    ...
    //private tanımlama yapıldığı için diğer sınıflardan erişebilmek için getter ve setter fonksiyonları
