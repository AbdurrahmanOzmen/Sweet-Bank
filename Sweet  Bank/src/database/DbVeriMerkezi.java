...
public class DbVeriMerkezi extends DbConnection{
    ...
    protected int kullaniciId = 0; //kullanıcı hesabında değil
    protected String adSoyad, telNo, tcNo, musteriNo; //arayüz kısmında güvenlik soruları ile alakalı işimiz yok.güenlik sorusu değişkenleri şifre değiştirme ve yenileme alanlarında kullanılacak
    protected double bakiye;
    protected double elektrikFaturasi,suFaturasi,dogalgazFaturasi,internetFaturasi;

    
    /*
    * Tanımlı değişkenlere arayüzdeki ekranlardan ulaşabilmek için yazılan getter ve setter fonksiyonları
    */
